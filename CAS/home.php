 ...
 <div class="container">
        ...
        include_once('CASconn.php');
         $username = $_GET['un'];
          ...
          ?>
          <a href="CASpartA.php" class="card-link">Add Details</a>
      ...
      <div class="card" style="width: 18rem;">
        <div class="card-body">
          ...
          <a href="CASBupdate.php?un=<?= $username ?>" class="card-link">Category I</a>
          <a href="CASpartB2.php" class="card-link">Category II</a>
        </div>
      </div>
    </div>
